        ...
        <div class="header">
            ...
            <div class="header-seccions">
                <ul>
                    ...
                    <li>Talleres</li>
                    <li>Contacto</li>
                    <li class="boton-login"><a href="{{ route('login') }}">Login</a><i class="fa-solid fa-right-to-bracket login"></i></li>
                </ul>
            </div>
        </div>
        <div class="main">
            <div class="main1">
                ...
                <div class="main1-botones">
                    ...
                    <button type="submit" class="registrarse">Registrate<i class="fa-solid fa-right-to-bracket login"></i></button>
                </div>
            </div>
            <div class="main2">
                <div class="main3">
